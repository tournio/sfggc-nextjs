  ...
  return (
    <Layout>
      <div className={styles.Rules}>
        ...
        {/*</a>*/}
        {/*<ol className='rule_text'>*/}
        {/*  <li>*/}
        {/*    The San Francisco Golden Gate Classic (SFGGC) is a United States Bowling Congress (USBC) certified*/}
        ...
        {/*    membership from both organizations. If membership is needed from either organization you may purchase a USBC*/}
        {/*    membership for $25.00 (US) and an IGBO membership for $25.00 (US). Active card-carrying members of the PBA*/}
        {/*    must state so on their entry form. Maximum of 1 PBA member allowed per team. IN THE BEST INTEREST OF*/}
        {/*    TOURNAMENT COMPETITION, THE DIRECTOR(S) RETAIN(S) THE RIGHT TO ACCEPT OR REJECT ANY TEAM OR INDIVIDUAL.*/}
        {/*  </li>*/}
        {/*  <li>*/}
        {/*    ENTERING AVERAGE: The tournament operates on the ideal of fair play. Should the Tournament Director(s)*/}
        ...
        {/*    submitting entering average. The*/}
        {/*    <strong>*/}
        {/*      highest*/}
        {/*    </strong>*/}
        {/*    of the following averages will be used:*/}
        {/*    <ol>*/}
        {/*      <li>*/}
        {/*        Submit the*/}
        {/*        <strong>*/}
        {/*          highest*/}
        {/*        </strong>*/}
        {/*        average from the following criteria:*/}
        {/*        <ol>*/}
        {/*          <li>*/}
        {/*            USBC 2018-2019 league average (minimum 21 games) (NOT COMPOSITE)*/}
        {/*          </li>*/}
        {/*          <li>*/}
        {/*            January 1, 2020 highest league average (minimum 21 games)*/}
        {/*          </li>*/}
        {/*          <li>*/}
        {/*            TOURNAMENT AVERAGE (TAD) composite from January 1st, 2019 to present (minimum 18 games). USBC rule*/}
        {/*            #319 applies in its entirety.*/}
        {/*          </li>*/}
        {/*          <li>*/}
        {/*            SPORT BOWLING average per USBC Rule #205 will be applied. Sport average converted per the USBC*/}
        {/*            average adjustment scale (rule #203).*/}
        {/*          </li>*/}
        {/*        </ol>*/}
        {/*      </li>*/}
        {/*      <li>*/}
        ...
        {/*        (such as brackets, mega brackets, etc.) in the previous 12 months, the actual scores and winnings from*/}
        {/*        the tournament must be reported for possible re-rating. Re-rating must be done before the entrant bowls.*/}
        {/*      </li>*/}
        {/*      <li>*/}
        {/*        It is the bowler’s responsibility to make sure SFGGC has their correct average based on the rules above*/}
        {/*        regardless of who may have submitted the average for you. Submitting an incorrect average shall be cause*/}
        {/*        for disqualification and forfeiture of entry fees and prize winnings.*/}
        {/*      </li>*/}
        {/*      <li>*/}
        {/*        The average of any bowler may be adjusted at the discretion of the Tournament Director(s) and we reserve*/}
        {/*        the right to utilize specialty tournaments and events (i.e., 5, 8 & 10 game tournaments, Vegas Pot*/}
        {/*        Games, etc.) in adjusting a bowler's entering average.*/}
        {/*        <ol>*/}
        {/*          <li>*/}
        {/*            Any average adjustment must be made before the completion of the entrant's first game of*/}
        {/*            competition. Any bowler unwilling to accept the average change will receive a refund, cease bowling*/}
        {/*            and receive a zero score for all games if a qualified bowler cannot be found as a replacement. Team*/}
        {/*            members will NOT receive a refund.*/}
        {/*          </li>*/}
        {/*        </ol>*/}
        {/*      </li>*/}
        {/*      <li>*/}
        {/*        SFGGC handicap is based on 90% of the difference between a bowler's entering average and the highest*/}
        {/*        average for the 2020 SFGGC tournament.*/}
        {/*      </li>*/}
        {/*    </ol>*/}
        {/*  </li>*/}
        {/*  <li>*/}
        {/*    There will be NO REFUNDS after acceptance of an entry by the tournament committee.*/}
        {/*    <p>*/}
        {/*      Entries must be accompanied by FULL AMOUNT OF FEES in the form of credit card, Paypal, personal checks,*/}
        {/*      certified checks, or money orders payable to SF Golden Gate Classic to secure your entry spot.*/}
        {/*    </p>*/}
        {/*    <p>*/}
        {/*      Entry fee breakdown:*/}
        {/*    </p>*/}
        {/*    <ol>*/}
        {/*      <li>*/}
        {/*        $99 - Entries received on or before Dec 15, 2019*/}
        {/*      </li>*/}
        {/*      <li>*/}
        {/*        $109 - Entries received between Dec 16, 2019 to Jan 15, 2020*/}
        {/*      </li>*/}
        {/*      <li>*/}
        {/*        $119 - Entries received on or after Jan 16, 2020*/}
        {/*      </li>*/}
        {/*    </ol>*/}
        {/*    <p>*/}
        {/*      Personal checks will not be accepted after February 7, 2020. Entries must be POSTMARKED by no later than*/}
        {/*      February 7, 2020. See Rule 2 for additional requirements.*/}
        {/*    </p>*/}
        {/*  </li>*/}
        {/*  <li>*/}
        {/*    Bowlers may bowl only once in each event. Each event consists of three (3) games, for a total of nine (9)*/}
        {/*    games. Team and Doubles events will be bowled back-to-back on Saturday.*/}
        {/*  </li>*/}
        {/*  <li>*/}
        {/*    All claims of error must be submitted, in writing, to the Tournament Director(s) within one (1) hour after*/}
        {/*    the bowler or team has bowled. In matters of dispute, the decision(s) of the Director(s) will be final,*/}
        {/*    unless an appeal is made in accordance with UBSC Rule #329.*/}
        {/*  </li>*/}
        {/*  <li>*/}
        {/*    Substitutes are able to bowl with the Director(s) approval. Substitutes must register at least one (1) hour*/}
        {/*    before the start of competition and must bowl in the same line-up position as the bowler they are replacing.*/}
        {/*  </li>*/}
        {/*  <li>*/}
        {/*    Late bowlers will start bowling in the frame they are ready to bowl; prior frames will be scored zero (0).*/}
        {/*    Absent bowlers will be scored zero (0).*/}
        {/*  </li>*/}
        {/*  <li>*/}
        {/*    Cash prizes: A bowler may win only one (1) special awards prize. Each event has its own prize list, based on*/}
        {/*    at least a 1:10 ratio. All prize fees collected for an event will be returned 100% to the participants of*/}
        {/*    that event. This does not include optional events.*/}
        {/*  </li>*/}
        {/*  <li>*/}
        {/*    Captains must check-in their teams at least thirty (30) minutes prior to the start of competition.*/}
        {/*  </li>*/}
        {/*  <li>*/}
        {/*    Bowlers will not be permitted to practice on their assigned lanes on the scheduled day of bowling. Bowlers*/}
        {/*    will be allowed 10 minutes of practice before the start of each of the three (3) events. All bowling events*/}
        {/*    will be held at Classic Bowling Center in Daly City.*/}
        {/*  </li>*/}
        {/*</ol>*/}
        {/*<h1 className='my-2 py-2'>*/}
        {/*  <a id='scratch_masters_rules'>*/}
        ...
        {/*    entrants. The Scratch Masters has a separate entry fee and the amount is based on the division. Prize money*/}
        {/*    for each division consists of the total entry fees received in that division.*/}
        {/*  </li>*/}
        {/*  <li>*/}
        {/*    Tournament Director(s) may place a bowler into a higher division at their discretion. Any such adjustment*/}
        {/*    will be made before the entrant bowls.*/}
        {/*  </li>*/}
        {/*  <li>*/}
        {/*    The scratch scores from Team and Doubles events ONLY from the SFGGC will be used to determine the eight (8)*/}
        {/*    qualifiers and one alternate in each division. Scores DO NOT carry over from the regular tournament. A tie*/}
        {/*    for 8th position is broken by bowling one complete game prior to play to determine the qualifier.*/}
        {/*  </li>*/}
        {/*  <li>*/}
        ...
        {/*  </li>*/}
        {/*  <li>*/}
        {/*    All 8 qualifiers will get 10 minutes of practice on division assigned lanes.*/}
        {/*  </li>*/}
        {/*  <li>*/}
        ...
        {/*  </li>*/}
        {/*  <li>*/}
        {/*    The total scratch scores will be added after the first 3 games, then 4 bowlers will be dropped (ranked*/}
        {/*    5th-8th for final standings) and 4 bowlers will advance. In the event there is a tie after the 3 games, a*/}
        {/*    <strong>*/}
        {/*      one ball*/}
        {/*    </strong>*/}
        ...
        {/*  </li>*/}
        {/*  <li>*/}
        {/*    The remaining 4 bowlers will bowl in a head to head, step-ladder fashion and all previous scores will be*/}
        {/*    discarded. The 4th place bowler will bowl the 3rd place bowler. The winner will advance and bowl the 2nd*/}
        {/*    place bowler and the winner of that game will bowl the 1st place qualifier for the championship. In each of*/}
        {/*    the step-ladder games, the bowler seeded higher will get to choose to finish first or last.*/}
        {/*  </li>*/}
        {/*  <li>*/}
        ...
        {/*    Scratch Masters competition. A bowler who does not check-in as specified will be immediately disqualified*/}
        {/*    and replaced by the alternate. If the alternate is not present, the spot is filled by the next highest*/}
        {/*    ranking bowler in the division present at the time of check-in.*/}
        {/*  </li>*/}
        {/*  <li>*/}
        {/*    The match game competition will begin within one hour of the end of team event on Sunday, February 16, 2020.*/}
        {/*    Each Division will bowl on a different set of eight (8) lanes. Bowlers must be physically present for*/}
        {/*    check-in following the Team event, NO EXCEPTIONS.*/}
        {/*  </li>*/}
        {/*  <li>*/}
        ...
        {/*  </li>*/}
        {/*  <li>*/}
        {/*    The Optional Scratch Masters payout will be 100% of the entry fees paid by participants by division. The*/}
        {/*    award ratio for Scratch Masters by division shall be at a minimum of 1 in 2 entries, with a maximum of 6*/}
        {/*    places paid in each division.*/}
        {/*  </li>*/}
        {/*  <li>*/}
        {/*    If fewer than 8 bowlers in in any Division sign up for Scratch Masters, they will be given the option of*/}
        {/*    having their fee refunded or moving up to the next higher division.*/}
        {/*  </li>*/}
        {/*  <li>*/}
